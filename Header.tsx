  ...
  return (
    <div className="w-full h-20 bg-amazon_blue text-lightText sticky top-0 z-50">
      <div className="h-full w-full mx-auto inline-flex items-center justify-between gap-1 mdl:gap-3 px-4">
        ...
        {/* <div className="h-10 rounded-md flex flex-grow-0 relative">
          <span onClick={()=>(!showAll)} className="w-14 h-full bg-gray-200 hover:bg-gray-300 border-2 cursor-point duration-300 text-sm text-amazon_blue font-fonttileFont flex items-center justify-center rounded-tl-md rounded-bl-md">All</span>
          <IoMdArrowDropdown/>
          {
            showAll && (
              <div>
                <ul className="absolue w-56 h-80 top-10 left-0 overflow-y-scroll overflow-x-hidden bg-white border-[1-px] border-amazon_blue text-black p-2 flex-col gap-2 z-50">
                  <li>All Department</li>
                </ul>
                </div>
            )
          }
          <input className="h-full text-base text-amazon_blue flex-grow outline-none border-none px-2" aria-label="Search" type="text"/>
        </div> */}
